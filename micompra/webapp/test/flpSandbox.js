		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mi Compra",
									"targetURL": "#claraucomicompra-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"claraucomicompra-display": {
								"semanticObject": "claraucomicompra",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl.arauco.micompra",
									"url": sap.ui.require.toUrl("cl/arauco/micompra")
								}
							}
						}
					}
