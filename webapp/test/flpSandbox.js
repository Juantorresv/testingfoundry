		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mi Compra",
									"targetURL": "#claraucommlog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"claraucommlog-display": {
								"semanticObject": "claraucommlog",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl.arauco.mmlog",
									"url": sap.ui.require.toUrl("cl/arauco/mmlog")
								}
							}
						}
					}
